...
def laser_weapon_armory():
    ...
    if guess == code:
        ...
        print "bridgs where you must place it in the right spot."
        return 'the_bridge'
    else:
        print "the lock buzzes on last time and then you heara sickening"
        print "melting sound as the mechanism is fused together."
        print "you decide to sit there, and finall the gothons blow up the"
        print "ship from their ship and ou die."
        return 'death'

def the_bridge():
    print "youburst ont othe bridge wiht hte neutron destruct bomb"
